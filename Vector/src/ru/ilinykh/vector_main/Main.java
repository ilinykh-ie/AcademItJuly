...
public class Main {
    public static void main(String[] args) {
        ...
        Vector vector1 = new Vector(array2.length, array1);
        ...
        vector2.setVectorComponent(6, 15);
        System.out.println("Результат получения компонента вектора" + vector2.getVectorComponent(6));
